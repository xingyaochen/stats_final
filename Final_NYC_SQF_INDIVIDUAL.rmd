...
qqplot(MaleAge,AllAge , main= "QQ Plot of Men vs All Ages")
abline(0,1)
...
The distributions between are approximately the same, because the `qqplot` results yielded points that fall pretty closely on the $y=x$ line. 
